...
def tensor_map(
    ...
    * Fill in the `out` array by applying `fn` to each
    ...
    def _map(
        ...
        out_index, in_index = np.zeros(len(out_shape), dtype=int), np.zeros(len(in_shape), dtype=int)
...
def tensor_zip(
    ...
    * Fill in the `out` array by applying `fn` to each
    ...
    def _zip(
        ...
        a_index, b_index = np.zeros(len(a_shape), dtype=int), np.zeros(len(b_shape), dtype=int)
        for i in range(len(out)):
            to_index(i, out_shape, out_index)
